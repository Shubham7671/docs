...
| clipSettings       | OBJECT    | Settings for clip generation. Includes `reelCount`, `prompt`, `keywords`, and `reelDuration`.                                                                                           | Optional  |
...
-   **reelCount** (INTEGER): Number of reels to generate
...
-   **type** (STRING): Type of B-roll footage. Options:
    -   `image`: Still images only
    -   `stock`: Stock video footage only
    -   `both`: Combination of images and stock footage (default)
